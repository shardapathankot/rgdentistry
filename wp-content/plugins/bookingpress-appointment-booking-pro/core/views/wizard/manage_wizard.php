...
<el-main class="bpa-fullscreen-wizard-setup">
	...
	<div class="bpa-fws__body">
		<el-tabs type="card" class="bpa-fws-tab-wrapper" v-model="bookingpress_active_tab">
			<el-tab-pane class="bpa-fws-tab-pane-item" name="company_settings" :disabled="bookingpress_disabled_tabs">
				...
				<div class="bpa-fws-tab-pane-body">
					...
					<div class="bpa-tpb__form-body">
						...
						<el-row :gutter="32">
							<el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
								<label class="bpa-form-label"><?php esc_html_e( 'Timezone', 'bookingpress-appointment-booking' ); ?></label>
								<el-select class="bpa-form-control" filterable v-model="wizard_steps_data.company_fields_data.timezone" placeholder="<?php esc_html_e('Select Timezone', 'bookingpress-appointment-booking'); ?>">
									<el-option-group v-for="(bookingpress_timezone_name, bookingpress_timezone_key) in timezone_lists" :label="bookingpress_timezone_key">
										<el-option v-for="item in bookingpress_timezone_name" :label="item" :value="item"></el-option>
									</el-option-group>
								</el-select>
							</el-col>
							<el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
						...
						<div class="bpa-tpb__full-width-inline">
							<el-row :gutter="32">
								<el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
									<label class="bpa-form-label"><?php esc_html_e( 'Do you have multiple staff?', 'bookingpress-appointment-booking' ); ?></label>	
								</el-col>
								<el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12" class="bpa-fwi__right">
									<el-radio label="yes" v-model="wizard_steps_data.company_fields_data.multiple_staff"><?php esc_html_e('Yes', 'bookingpress-appointment-booking'); ?></el-radio>
									<el-radio label="no" v-model="wizard_steps_data.company_fields_data.multiple_staff"><?php esc_html_e('No', 'bookingpress-appointment-booking'); ?></el-radio>
								</el-col>
							</el-row>
						</div>
						<div class="bpa-tpb__full-width-inline">
				...
				<div class="bpa-fws-tab-pane-body">
					...
					<div class="bpa-tpb__form-body">
						...
						<div class="bpa-tpb__full-width-inline">
							<el-row>
								<el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
									<label class="bpa-form-label"><?php esc_html_e( 'Enable Invoice Option', 'bookingpress-appointment-booking' ); ?></label>	
								</el-col>
								<el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12" class="bpa-fwi__right">
									<el-switch class="bpa-swtich-control" v-model="wizard_steps_data.booking_options.enable_invoice" @change="bookingpress_change_invoice($event)"></el-switch>
								</el-col>
							</el-row>
						</div>
						<div class="bpa-tpb__full-width-inline">
							<el-row>
								<el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
									<label class="bpa-form-label"><?php esc_html_e( 'Enable Tax Option', 'bookingpress-appointment-booking' ); ?></label>	
								</el-col>
								<el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12" class="bpa-fwi__right">
									<el-switch class="bpa-swtich-control" v-model="wizard_steps_data.booking_options.enable_tax" @change="bookingpress_change_tax($event)"></el-switch>
								</el-col>
							</el-row>
						</div>
						<div class="bpa-tpb__full-width-inline">
							<el-row>
								<el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
									<label class="bpa-form-label"><?php esc_html_e( 'Allow Discount Coupon', 'bookingpress-appointment-booking' ); ?></label>	
								</el-col>
								<el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12" class="bpa-fwi__right">
									<el-switch class="bpa-swtich-control" v-model="wizard_steps_data.booking_options.allow_discount" @change="bookingpress_change_discount($event)"></el-switch>
								</el-col>
							</el-row>
						</div>
					</div>
			...
			<el-tab-pane class="bpa-fws-tab-pane-item" v-if="wizard_steps_data.company_fields_data.multiple_staff == 'yes'" name="staff_options" :disabled="bookingpress_disabled_tabs">
				<div class="bpa-tpi__tab-menu-item" slot="label">	
					<span class="bpa-tpi__counter">03</span>
					<div class="bpa-tpi__item-link"><?php esc_html_e('Staff', 'bookingpress-appointment-booking'); ?></div>
				</div>
				<div class="bpa-fws-tab-pane-body">
					<div class="bpa-tpb__head">
						<h3><?php esc_html_e('Staff Details', 'bookingpress-appointment-booking'); ?></h3>
						<p><?php esc_html_e('Please configure some basic options about staff and add your staff here', 'bookingpress-appointment-booking'); ?></p>
					</div>
					<div class="bpa-tpb__form-body">
						<div class="bpa-tpb__form-body-section">
							<h4><?php esc_html_e('Staff Permissions', 'bookingpress-appointment-booking'); ?></h4>							
							<div class="bpa-fbs__wrapper">
								<div class="bpa-tpb__full-width-inline">
									<el-row>
										<el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
											<label class="bpa-form-label"><?php esc_html_e( 'Allow Edit/Delete their Appointments', 'bookingpress-appointment-booking' ); ?></label>	
										</el-col>
										<el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12" class="bpa-fwi__right">
											<el-switch class="bpa-swtich-control" v-model="wizard_steps_data.staffmember_options.allow_edit_delete_appointments"></el-switch>
										</el-col>
									</el-row>
								</div>
								<div class="bpa-tpb__full-width-inline">
									<el-row>
										<el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
											<label class="bpa-form-label"><?php esc_html_e( 'Allow customer handling', 'bookingpress-appointment-booking' ); ?></label>	
										</el-col>
										<el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12" class="bpa-fwi__right">
											<el-switch class="bpa-swtich-control" v-model="wizard_steps_data.staffmember_options.allow_customer_handling"></el-switch>
										</el-col>
									</el-row>
								</div>
								<div class="bpa-tpb__full-width-inline">
									<el-row>
										<el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
											<label class="bpa-form-label"><?php esc_html_e( 'Can view payment activities', 'bookingpress-appointment-booking' ); ?></label>	
										</el-col>
										<el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12" class="bpa-fwi__right">
											<el-switch class="bpa-swtich-control" v-model="wizard_steps_data.staffmember_options.allow_view_payments"></el-switch>
										</el-col>
									</el-row>
								</div>
							</div>
						...
						<div class="bpa-tpb__form-body-section bpa-fbs--has-form-label-spacing">
							<h4><?php esc_html_e('Add New Staff', 'bookingpress-appointment-booking'); ?></h4>							
							<div class="bpa-fbs__staff-form-row">
								<el-row :gutter="24" v-for="(staff_details, index) in wizard_steps_data.staffmember_options.staffmember_details">
									<el-col :xs="06" :sm="06" :md="06" :lg="06" :xl="06">
										<label class="bpa-form-label">{{ staff_details.firstname_label }}</label>	
										<el-input class="bpa-form-control" v-model="wizard_steps_data.staffmember_options.staffmember_fields_details[index].firstname" :placeholder="staff_details.firstname_label"></el-input>
									</el-col>
									<el-col :xs="06" :sm="06" :md="06" :lg="06" :xl="06">
										<label class="bpa-form-label">{{ staff_details.lastname_label }}</label>	
										<el-input class="bpa-form-control" v-model="wizard_steps_data.staffmember_options.staffmember_fields_details[index].lastname" :placeholder="staff_details.lastname_label"></el-input>
									</el-col>
									<el-col :xs="06" :sm="06" :md="06" :lg="06" :xl="06">
										<label class="bpa-form-label">{{ staff_details.email_label }}</label>	
										<el-input class="bpa-form-control" v-model="wizard_steps_data.staffmember_options.staffmember_fields_details[index].email" :placeholder="staff_details.email_label"></el-input>
									</el-col>
									<el-col :xs="06" :sm="06" :md="06" :lg="06" :xl="06">
										<label class="bpa-form-label">{{ staff_details.phone_number_label }}</label>	
										<el-input class="bpa-form-control" v-model="wizard_steps_data.staffmember_options.staffmember_fields_details[index].phone_number" :placeholder="staff_details.phone_number_label"></el-input>
									</el-col>
									<div class="bpa-sfr__action-icon">
										<a href="javascript:void(0)" @click="bpa_remove_staff(index)" v-if="index != 0">
											<span class="material-icons-round">remove_circle</span>
										</a>
										<a href="javascript:void(0)" @click="bpa_add_staff" v-if="index == 0">
					...
					<div class="bpa-tpb__foot-action-btns">
						<div class="bpa-fab--wrapper">
							<el-button class="bpa-btn bpa-btn__medium" @click="bookingpress_previous_tab('staff_options')">
								<span class="material-icons-round">west</span>
								<?php esc_html_e( 'Prev', 'bookingpress-appointment-booking' ); ?>
							</el-button>
							<el-button class="bpa-btn bpa-btn--primary bpa-btn__medium" @click="bookingpress_next_tab('staff_options')">
								<?php esc_html_e( 'Next', 'bookingpress-appointment-booking' ); ?>
								<span class="material-icons-round">east</span>
							</el-button>
						</div>
			...
			<el-tab-pane class="bpa-fws-tab-pane-item" name="service_options" :disabled="bookingpress_disabled_tabs">
				<div class="bpa-tpi__tab-menu-item" slot="label">	
					<span class="bpa-tpi__counter" v-if="wizard_steps_data.company_fields_data.multiple_staff == 'yes'">04</span>
					<span class="bpa-tpi__counter" v-else>03</span>
			...
			<el-tab-pane class="bpa-fws-tab-pane-item" name="styling_options" :disabled="bookingpress_disabled_tabs">
				<div class="bpa-tpi__tab-menu-item" slot="label">	
					<span class="bpa-tpi__counter" v-if="wizard_steps_data.company_fields_data.multiple_staff == 'yes'">05</span>
					<span class="bpa-tpi__counter" v-else>04</span>
				...
				<div class="bpa-fws-tab-pane-body">
					...
					<div class="bpa-tpb__form-body bpa-tbp--styling-tab-body">
						...
						<div class="bpa-tpb__full-width-inline">
							<el-row>
								<el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
									<label class="bpa-form-label"><?php esc_html_e( 'Prefered Booking Form Sequence', 'bookingpress-appointment-booking' ); ?></label>	
								</el-col>
								<el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12" class="bpa-fwi__right">
									<el-radio v-model="wizard_steps_data.styling_options.booking_form_sequence" label="service"><?php esc_html_e('Select Service', 'bookingpress-appointment-booking'); ?> > <?php esc_html_e('Select Staff', 'bookingpress-appointment-booking'); ?></el-radio>
									<el-radio v-model="wizard_steps_data.styling_options.booking_form_sequence" label="staff"><?php esc_html_e('Select Staff', 'bookingpress-appointment-booking'); ?> > <?php esc_html_e('Select Service', 'bookingpress-appointment-booking'); ?></el-radio>
								</el-col>
							</el-row>
						</div>
					</div>
			...
			<el-tab-pane class="bpa-fws-tab-pane-item" name="final_step" :disabled="bookingpress_disabled_tabs">
				...
				<div class="bpa-tpi__tab-menu-item" slot="label">	
					<span class="bpa-tpi__counter" v-if="wizard_steps_data.company_fields_data.multiple_staff == 'yes'">06</span>
					<span class="bpa-tpi__counter" v-else>05</span>
						...
						<div class="bpa-fsb__body">
							<div class="bpa-fsb-site-detail-item-row">
								...
								<div class="bpa-sd__items">
									<div class="bpa-sd__item">
										<p><?php echo esc_url_raw( BOOKINGPRESS_HOME_URL ) . "/book-appointment"; ?></p>
										<span class="material-icons-round" @click="bookingpress_copy_content('<?php echo esc_url_raw( BOOKINGPRESS_HOME_URL )."/book-appointment"; ?>')">content_copy</span>
									</div>
									<div class="bpa-sd__item">
										<p><?php echo esc_url_raw( BOOKINGPRESS_HOME_URL )."/my-bookings"; ?></p>
										<span class="material-icons-round" @click="bookingpress_copy_content('<?php echo esc_url_raw( BOOKINGPRESS_HOME_URL )."/my-bookings"; ?>')">content_copy</span>
									</div>
								</div>
							</div>
							...
							<div class="bpa-fsb-site-detail-item-row __bpa-has-btns">
								...
								<div class="bpa-sdi__social-links">
									<a href="https://www.facebook.com/BookingPressPlugin" target="_blank"><img src="<?php echo esc_url(BOOKINGPRESS_PRO_IMAGES_URL . '/fb-filled-circle.png'); ?>"></a>
									<a href="https://www.youtube.com/c/BookingPress" target="_blank"><img src="<?php echo esc_url(BOOKINGPRESS_PRO_IMAGES_URL . '/yt-filled-circle.png'); ?>"></a>
								</div>
							</div>
						</div>
					</div>
...
<el-dialog id="bpa_license_activation" custom-class="bpa-dialog bpa-dialog--addon-configure bpa-dialog--activate-license" :visible.sync="open_license_activation_modal" :close-on-press-escape="close_wizard_modal_on_esc">
	<div class="bpa-dialog-heading">
		<el-row type="flex">
			<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
				<h1 class="bpa-page-heading"><?php esc_html_e('Activate Your License', 'bookingpress-appointment-booking'); ?></h1>
			</el-col>
		</el-row>
	</div>
	<div class="bpa-dialog-body">
		<el-form>
			<el-row type="flex" :gutter="24">
				...
				<template #label>
							<span class="bpa-form-label"><?php esc_html_e( 'Select Package', 'bookingpress-appointment-booking' ); ?></span>
						</template> 
                            <el-select class="bpa-form-control" v-model="wizard_steps_data.license_package">
				...
				<el-col :xs="20" :sm="20" :md="20" :lg="20" :xl="20">
					<el-form-item>
						<template #label>
							<span class="bpa-form-label"><?php esc_html_e( 'License Key', 'bookingpress-appointment-booking' ); ?></span>
						</template>             
						<el-input class="bpa-form-control" v-model="wizard_steps_data.bookingpress_license_key" placeholder="<?php esc_html_e( 'Enter your license key', 'bookingpress-appointment-booking' ); ?>"></el-input>
					</el-form-item> 
				</el-col>
				<el-col :xs="04" :sm="04" :md="04" :lg="04" :xl="04" class="bpa-dialogn--is-col-vertically-bottom">
					<el-button class="bpa-btn bpa-btn--primary bpa-btn__medium bpa-btn--full-width" @click="bookingpress_license_verification">
						<?php esc_html_e( 'Connect', 'bookingpress-appointment-booking' ); ?>
					</el-button>
				</el-col>
			</el-row>
			<el-row type="flex" :gutter="24" class="bpa-license-res-msg">
				<el-col :xs="20" :sm="20" :md="20" :lg="20" :xl="20">
					<span class="bpa-license-error" v-if="wizard_steps_data.bookingpress_license_is_valid == 'false' && wizard_steps_data.bookingpress_err_msg != ''">{{ wizard_steps_data.bookingpress_err_msg }}</span>
					<span class="bpa-license-success" v-if="wizard_steps_data.bookingpress_license_is_valid == 'true' && wizard_steps_data.bookingpress_success_msg != ''">{{ wizard_steps_data.bookingpress_success_msg }}</span>
				</el-col>
			</el-row>
		</el-form>
	</div>
        ...
        <el-row>
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <div class="bpa-df-btn-group">
                    <el-button class="bpa-btn bpa-btn__medium" @click="open_license_activation_modal = false"><?php esc_html_e('Close', 'bookingpress-appointment-booking'); ?></el-button>
                </div>
            </el-col>
        </el-row>
    </div>

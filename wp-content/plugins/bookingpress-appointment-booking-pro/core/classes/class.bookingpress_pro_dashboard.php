...
if ( ! class_exists( 'bookingpress_pro_dashboard' ) ) {
	class bookingpress_pro_dashboard Extends BookingPress_Core {
		...
		function bookingpress_modify_dashboard_data_fields_func( $bookingpress_dashboard_vue_data_fields ) {
			...
			$bookingpress_dashboard_vue_data_fields['bpa_staff_refund_cap'] = $bookingpress_staff_refund_cap_check;
			$bookingpress_check_user_role = $BookingPressPro->bookingpress_check_user_role( 'bookingpress-staffmember' );
			$bookingpress_dashboard_vue_data_fields['bpa_chk_staff_role'] = $bookingpress_check_user_role;

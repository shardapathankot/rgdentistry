...
= 2.1 (Released: April 10, 2024) =
* Compatibility check up to version 6.5

= 2.0.1 (Released: February 21, 2024) =
* Bug Fixed: CSRF vulnerability while generating child theme (Reported by: Darius Sveikauskas https://patchstack.com)

= 2.0 (Released: November 15, 2023) =
* Compatibility check up to version 6.4

= 1.9 (Released: January 30, 2023) =
* Bug Fixed: Issue when child theme name starts from integer
